...
public class HeroTest {
	...
	public void setUpFixture(){
		...
		armor2 = new Armor(13, 64, new Ducat(654), 0, Unit.KG);
		...
		backpack = new Backpack(new Ducat(132), 261, 0, Unit.KG);
	...
	public void testHero_LegalCase(){
		...
		Armor armor3 = new Armor(11, 20, new Ducat(562), 48, Unit.KG);
	...
	public void testGetMaximumCapacity(){
		Armor a1 = new Armor(17, 64, new Ducat(654), 0, Unit.KG);
		...
		Armor a2 = new Armor(19, 64, new Ducat(654), 0, Unit.KG);
		...
		Armor a3 = new Armor(23, 64, new Ducat(654), 0, Unit.KG);
		...
		Armor a4 = new Armor(29, 64, new Ducat(654), 0, Unit.KG);
		...
		Armor a5 = new Armor(29, 64, new Ducat(654), 0, Unit.KG);
	...
	public void testCannotAddToAnchor(){
		...
		Armor a1 = new Armor(31, 64, new Ducat(654), 0, Unit.KG);
		Armor a2 = new Armor(37, 64, new Ducat(654), 0, Unit.KG);
		hero2.addToAnchor(a1, "Body");
		hero2.addToAnchor(backpack, "Back");
		backpack.addToStorage(a2);
		Armor a3 = new Armor(37, 64, new Ducat(654), 0, Unit.KG);
	...
	public void testConstructorIllegalName() throws IllegalArgumentException {
		Armor a = new Armor(41, 64, new Ducat(654), 0, Unit.KG);
	...
	public void testConstructorAnchorObjectsNotRightSize()
			throws IllegalArgumentException {
		Armor a = new Armor(43, 64, new Ducat(654), 0, Unit.KG);
	...
	public void testConstructorPurseOnBelt1() throws IllegalArgumentException {
		Armor a = new Armor(47, 64, new Ducat(654), 0, Unit.KG);
		Weapon w = new Weapon(12, Unit.KG, 42);
	...
	public void testConstructorPurseOnBelt2() throws IllegalArgumentException {
		Armor a = new Armor(51, 64, new Ducat(654), 0, Unit.KG);
